...
//gets euclidian distance of every point from median point
...
//groups the points with nearest median point
...
//clears the sum and new median points 
...
//calculates the sum and count of points in a group
...
//finds the new medians using sum and count calculated previously
